...
exclude_keywords =  ["減少"]
# 加粗关键字
red_keywords = ["大量","光通信","Oasis","井村","3Dインベストメント","シティインデックス","エフィッシモ","ブラックロック"]
...
for page in range(start_page, end_page + 1):
    ...
    url = f'https://kabutan.jp/news/marketnews/?category=12&page={page}'
...
html_file_name = f'out/5percent_{datetime.now().strftime("%Y%m%d%H%M")}.html'
